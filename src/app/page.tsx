  ...
  return <div className="app">
    ...
    <main>
      <div className="flexbox">
        ...
        <svg width="360" height="439" viewBox="0 0 365 439" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flexbox">
        ...
        <svg width="360" height="500" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
